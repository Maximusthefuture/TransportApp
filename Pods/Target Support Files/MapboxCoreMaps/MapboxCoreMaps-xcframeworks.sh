...
install_xcframework "${PODS_ROOT}/MapboxCoreMaps/MapboxCoreMaps.xcframework" "MapboxCoreMaps" "framework" "ios-x86_64-maccatalyst" "ios-arm64" "ios-arm64_x86_64-simulator"
